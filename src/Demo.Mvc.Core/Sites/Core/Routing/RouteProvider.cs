...
namespace Demo.Mvc.Core.Sites.Core.Routing
{
    public class RouteProvider : IRouteProvider
    {
        ...
        private List<Mvc.Core.Routing.Implementation.Domain> domains;
        private List<Route> routes;

        public IEnumerable<Mvc.Core.Routing.Implementation.Domain> Domains
        {
            get
            {
                if (domains != null)
                ...
                domains = new List<Mvc.Core.Routing.Implementation.Domain>();


                foreach(var domain in _businessConfig.Domains)
                {
                    domains.Add(new Mvc.Core.Routing.Implementation.Domain()
                    {
