  ...
  switch (action.type) {
    case 'error': {
      return {
        ...state,
        [formPropertyName]: {
          ...state[formPropertyName],
          email: {
            ...state[formPropertyName].email,
          ...
          <div className="panel-body">
            <form
              ...
              <div className="row">
                <div
                  className={
                    'form-group form-group-lg ' + status.email.className
                  }>
                ...
                <div
                  className={
                    'form-group form-group-lg ' + status.password.className
                  }>
                ...
                <div className="form-group form-group-lg">
                  <div className="col-sm-6">
                    <a href={urlCreateUser()} onClick={goCreateUser}>
                      Créer un compte
                    </a>
                  </div>
                  <div className="col-sm-6">
                    <a
                      href="/utilisateur/reset-password?dm=false"
                      onClick={goLostPassword}>
                      Mot de passe perdu
                    </a>
                  </div>
                </div>
                <div className="form-group">
                  <div className="col-sm-offset-3 col-sm-9">
                    <button type="submit" className="btn btn-lg btn-success">
                      <span className="glyphicon glyphicon-ok" /> Valider
                    </button>
                  </div>
                </div>
              </div>
