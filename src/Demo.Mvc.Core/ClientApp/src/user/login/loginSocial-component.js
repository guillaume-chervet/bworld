        ...
        <div className="panel panel-default">
          <div className="panel-heading">
            <h2>
              ...
              <a
                href={domainLoginUrl}
                alt="Système d'authentification centralisé">
                <span
          ...
          <div className="panel-body">
            <form action={postUrl} method="post" noValidate="novalidate">
              ...
              <div className="row">
                <div className="col-sm-6 mw-login-panel">
                  <button
                    type="submit"
                    className="btn-lg btn-social btn-google"
                    id="Google"
                    name="provider"
                    value="Google"
                ...
                <div className="col-sm-6 mw-login-panel">
                  <button
                    type="submit"
                    className="btn-lg btn-social btn-facebook"
                    id="Facebook"
                    name="provider"
                    value="Facebook"
                ...
                <div className="col-sm-6 mw-login-panel">
                  <button
                    type="submit"
                    className="btn-lg btn-social btn-microsoft"
                    id="Microsoft"
                    name="provider"
                    value="Microsoft"
                ...
                <div className="col-sm-6 mw-login-panel">
                  <button
                    ...
                    name="provider"
                    value="Twitter"
                    className="btn-lg btn-social btn-twitter"
                    title="Connexion avec votre compte Twitter">
            ...
            <p>
              Si vous n'êtes pas inscrit, cliquer sur l'un des boutons afin de
              commencer.
            </p>
          </div>
        </div>
