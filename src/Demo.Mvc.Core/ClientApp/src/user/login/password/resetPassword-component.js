...
const ResetPassword = () => {
  ...
  return (<div className="row">
        <div className="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-0">
          ...
          <h2>Votre email</h2>
          <form role="form" name="form" className="form-horizontal" encType="multipart/form-data" noValidate
                onSubmit={onSubmit}>

            <div className={"form-group form-group-lg "+ status.email.className} >
              <label htmlFor="Email" className="col-sm-3 control-label">Email: </label>
              <div className="col-sm-4">
                <input id="Email" type="email" name="email" value={state.form.email.value} {...events} className="form-control" />
              ...
              <div className="form-group form-group-lg">
                <div className="col-sm-offset-3 col-sm-9">
                  <button type="submit" className="btn btn-lg btn-warning"><span
                      className="glyphicon glyphicon-ok"></span> Demander
                  </button>
                </div>
              </div>
            </div>
